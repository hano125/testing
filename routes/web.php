...
// -------------------------normal controller and route----------------------------
    Route::get("show",[postController::class,'showPage']);
    Route::post("post/create",[postController::class,'showPage']);
    Route::put("post/update/{id}",[postController::class,'showPage']);
    Route::post("post/edit/{id}",[postController::class,'showPage']);
    Route::post("post/delete/{id}",[postController::class,'showPage']);
